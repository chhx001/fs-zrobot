...
#define DEVICE_NAME "zrarm_gpio_dev"
...
#define STATUS_CN1 (gpio_status & 0x3fffff)
...
void gpio_set_up(int num)
{
	...
	iowrite32(STATUS_CN1,gpio_baseaddr + GPIO_DATA_OFFSET(num));
}
...
u32 gpio_get()
{
	...
	gpio_status = (ioread32(gpio_baseaddr + GPIO_CN1_OFFSET) & 0x3fffff);
	return gpio_status;
}
